  ...
  <form onsubmit="app.carsController.handleSubmit('${car.id}')">
    <div class="mb-3 d-flex justify-content-between">
      <div>
        ...
        <input type="text" class="form-control" name="make" id="make" aria-describedby="make" placeholder="Make..." required value="${car.make}">
      </div>
      <div>
    ...
    <div class="mb-3">
      <div>
        ...
        <textarea type="text" class="form-control" name="description" id="description"
          aria-describedby="description" placeholder="Description..." min="5" max="250">${car.description} </textarea>
      </div>
    </div>
